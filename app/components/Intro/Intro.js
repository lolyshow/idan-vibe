		...
		<section
			...
			<div className="absolute w-full h-full top-0 left-0">
				...
				<video
					...
					playsInline>
					<source src="./new_forwebsite.mp4" type="video/mp4" />
					<source src="/new_forwebsite.mp4" type="video/mp4" />
					<p>
						Your browser doesn&#8217;t support HTML video. Here is a
						<a href="./new_forwebsite.mp4">link to the video</a> instead.
					</p>
				</video>
			</div>
			...
			<CookieConsent
				...
				containerClasses="w-full fixed !bottom-0 bg-[#f0ede3] p-3 z-[50] lg:bg-stone-300/70 lg:backdrop-blur-lg lg:left-8 lg:!bottom-2 lg:rounded-md lg:max-w-md"
